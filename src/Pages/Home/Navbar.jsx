...
const Navbar = () => {
    ...
    const menuItems =
        <div className="md:flex gap-4 items-center text-[16px] ">
            ...
            <NavLink to="/myCollege" className={({ isActive }) => isActive ? "active" : "default"}>
                My College</NavLink>
        ...
        <div className="navbar bg-blue-900 text-white">
            <div className="navbar-start">
                <div className="dropdown ">
                    ...
                    <ul tabIndex={0} className="menu  dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box  text-black">
                        {menuItems}
                    </ul>
                </div>
